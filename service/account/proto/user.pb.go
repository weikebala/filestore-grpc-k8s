...
func (*UnimplementedUserServiceServer) Signup(ctx context.Context, req *ReqSignup) (*RespSignup, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Signup not implemented")
}
func (*UnimplementedUserServiceServer) Signin(ctx context.Context, req *ReqSignin) (*RespSignin, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Signin not implemented")
}
func (*UnimplementedUserServiceServer) UserInfo(ctx context.Context, req *ReqUserInfo) (*RespUserInfo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UserInfo not implemented")
}
func (*UnimplementedUserServiceServer) UserFiles(ctx context.Context, req *ReqUserFile) (*RespUserFile, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UserFiles not implemented")
}
func (*UnimplementedUserServiceServer) UserFileRename(ctx context.Context, req *ReqUserFileRename) (*RespUserFileRename, error) {
