...
import (
	...
	"filestore-grpc-k8s/service/dbproxy/mapper"
...
func (db *DBProxy) ExecuteAction(ctx context.Context, req *dbProxy.ReqExec) (*dbProxy.RespExec, error) {
